...
**Bulk-Inserts an einen Subagenten delegieren, nicht selbst durchführen**, wenn die generierte SQL mehr als ~100KB wird (bei 7.543 Zeilen: 31 Batches à 250 Zeilen) — sonst läuft das eigene Kontextfenster mit rohem SQL-Text voll. Kleinere Mengen (Verben/Adjektive-Listen, je unter 300 Zeilen) selbst in 2-4 Batches direkt einfügen, das bleibt handhabbar.
